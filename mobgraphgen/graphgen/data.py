...
class Graph_DFS_code_from_file(Dataset):
    ...
    def __getitem__(self, idx):
      if self.args.len_graphs>self.args.subdir_size:
        with open(os.path.join(self.dataset_path, str(get_subfolder_number(int(self.graph_list[idx]),self.args.subdir_size))+"/") + 'graph' + str(self.graph_list[idx]) + '.dat', 'rb') as f:
