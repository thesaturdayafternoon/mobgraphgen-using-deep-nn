...
#added by Behnaz
from build_real_mob_graph import load_graphs_for_cities
...
from build_real_mob_graph import remove_folder
import shutil
...
#added by Behnaz
import shutil
#from datasets.preprocess import get_fileslist_from_subdires
...
def create_graphs(args):
    ...
    if args.graphs_created:
      min_dfscode_tensor_path = os.path.join('/content/', 'min_dfscode_tensors/')
    else:
      min_dfscode_tensor_path = os.path.join(base_path, 'min_dfscode_tensors/')
    #added by Behnaz
    ...
    if args.produce_graphs:
        ...
        #added by Behnaz     
          ...
          #print("in datasets/process_dataset and len(graphs) = ",len(graphs))
    ...
    if args.note == 'DFScodeRNN' and args.produce_min_dfscode_tensors:
      ...
      #added by Behnaz
      #print("min_dfscode_tensor_path = ",min_dfscode_tensor_path)
      #min_dfscodes_tensors_filenames=[name for name in os.listdir(min_dfscode_tensor_path) if name.endswith(".dat")]
